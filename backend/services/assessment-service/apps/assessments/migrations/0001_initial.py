    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "assessment_type",
                    models.CharField(
                        choices=[("quiz", "Quiz"), ("exam", "Exam"), ("assignment", "Assignment")],
                        max_length=32,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["available_from", "available_until"], name="idx_assess_window"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["submission_type", "submission_id"],
                        name="idx_submit_audit_submission",
                    ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("assessment",), name="uq_assignments_assessment_id"
                    )
                ],
            },
        ),
        migrations.AddIndex(
            model_name="question",
            index=models.Index(
                fields=["question_bank", "question_type"], name="idx_questions_bank_type"
            ),
        ),
        migrations.AddIndex(
            model_name="question",
            index=models.Index(
                fields=["question_bank", "status"], name="idx_questions_bank_status"
            ),
        ),
        migrations.AddConstraint(
            model_name="quiz",
            constraint=models.UniqueConstraint(
                fields=("assessment",), name="uq_quizzes_assessment_id"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddConstraint(
            model_name="quizanswer",
            constraint=models.UniqueConstraint(
                fields=("quiz_attempt", "question"), name="uq_qanswers_attempt_question"
            ),
        ),
        migrations.AddIndex(
