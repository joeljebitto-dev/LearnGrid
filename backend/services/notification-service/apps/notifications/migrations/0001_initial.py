    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["recipient_profile_id", "-created_at"],
                        name="idx_notify_recipient_created",
                    ),
                    models.Index(
                        fields=["recipient_profile_id", "read_at"],
                        name="idx_notify_recipient_unread",
                    ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("event_type", "channel"), name="uq_notify_tpl_event_channel"
                    )
                ],
            },
        ),
