...
urlpatterns = [
    ...
    path("templates/<uuid:template_id>/", NotificationTemplateDetailView.as_view(), name="notification-template-detail"),
    ...
    path("preferences/", NotificationPreferenceListCreateView.as_view(), name="notification-preference-list-create"),
    path("delivery-attempts/", DeliveryAttemptListView.as_view(), name="delivery-attempt-list"),
    path("delivery-attempts/<uuid:attempt_id>/", DeliveryAttemptDetailView.as_view(), name="delivery-attempt-detail"),
