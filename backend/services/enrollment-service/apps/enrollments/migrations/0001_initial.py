    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["batch_id", "course_id"], name="idx_batch_enroll_batch_course"
                    ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["cohort_id", "course_id"], name="idx_cohort_enroll_course"
                    ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["student_profile_id", "status"], name="idx_enroll_student_status"
                    ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["course_id", "access_status"], name="idx_access_course_status"
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
                        condition=models.Q(("access_status", "active")),
                        fields=("student_profile_id", "course_id"),
