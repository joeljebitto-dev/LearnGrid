...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "insecure-local-grading-service")
...
CONTENT_SERVICE_BASE_URL = os.getenv("CONTENT_SERVICE_BASE_URL", "http://127.0.0.1:8004")
PROGRESS_SERVICE_BASE_URL = os.getenv("PROGRESS_SERVICE_BASE_URL", "http://127.0.0.1:8006")
ASSESSMENT_SERVICE_BASE_URL = os.getenv("ASSESSMENT_SERVICE_BASE_URL", "http://127.0.0.1:8007")
GRADING_CERTIFICATE_DEFAULT_PASS_PERCENT = os.getenv("GRADING_CERTIFICATE_DEFAULT_PASS_PERCENT", "70")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": ["apps.grading.authentication.JWTAuthentication"],
}
