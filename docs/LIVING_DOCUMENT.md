...
filtering, pagination, and soft-delete behavior. Most course/content domain models, production
Kubernetes manifests, and remaining non-auth feature APIs remain for later tasks.
