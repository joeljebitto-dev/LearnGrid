# LearnGrid LMS DB Structure

Source of truth: [DATABASE_SCHEMA.md](DATABASE_SCHEMA.md)  
Related database designs: [db-design/](db-design/README.md)  
...
Related implemented design: [DBD-002 Auth Token And Session](db-design/DBD-002-auth-token-session.md), [DBD-003 RBAC Authorization](db-design/DBD-003-rbac-authorization.md)

### DB-AUTH-001 `accounts`
Owning service: `auth-service`  
Table ID: `DB-AUTH-001`  
Table name: `accounts`
...
Related implemented design: [DBD-004 User Profile Management](db-design/DBD-004-user-profile-management.md), [DBD-005 Institution, Batch, And Department Management](db-design/DBD-005-institution-batch-department-management.md)

### DB-USER-001 `institutions`
Owning service: `user-service`  
Table ID: `DB-USER-001`  
...
Owning service: `course-service`  
Table ID: `DB-COURSE-004`  
Table name: `course_category_links`
...
Owning service: `course-service`  
Table ID: `DB-COURSE-005`  
Table name: `course_tag_links`
...
Owning service: `content-service`
Related implemented design: [DBD-008 Content Upload, Storage, And Access](db-design/DBD-008-content-upload-storage-access.md).

### DB-CONTENT-001 `content_assets`
Owning service: `content-service`  
Table ID: `DB-CONTENT-001`  
...
Owning service: `content-service`  
Table ID: `DB-CONTENT-004`  
Table name: `signed_access_records`
...
Owning service: `enrollment-service`
Related implemented design: [DBD-009 Enrollment And Access Management](db-design/DBD-009-enrollment-access-management.md).

### DB-ENROLL-001 `enrollments`
Owning service: `enrollment-service`  
Table ID: `DB-ENROLL-001`  
...
Owning service: `progress-service`
Related implemented design: [DBD-010 Learning Progress Tracking](db-design/DBD-010-learning-progress-tracking.md).

### DB-PROGRESS-001 `lesson_progress`
Owning service: `progress-service`  
Table ID: `DB-PROGRESS-001`  
...
Owning service: `analytics-service`  
Table ID: `DB-ANALYTICS-001`  
Table name: `event_facts`
...
Owning service: `analytics-service`  
Table ID: `DB-ANALYTICS-005`  
Table name: `search_index_records`
